...
var buildaPrams = function (envType, platType) {
    // 获取域
    var uri = lodash.get(ENV_DOMAIN, envType + "." + platType);
    if (!uri) {
        return false;
    }
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, produce(context, function (draft) {
                        draft.config.envs = __assign(__assign({}, draft.config.envs), { 
                            /** 代理环境 */
                            REACT_APP_PROXY_ENV: answers_1.proxyEnv, 
                            /** 代理平台 */
                            REACT_APP_PROXY_PLAT: answers_1.proxyPlat, 
                            /** 代理请求所需参数 */
                            REACT_APP_PROXY_PARAMS: buildaPrams(answers_1.proxyEnv, answers_1.proxyPlat), 
                            /** 代理域名 */
                            REACT_APP_PROXT_LOGIN_DOMAIN: lodash.get(ENV_DOMAIN, answers_1.proxyEnv + "." + answers_1.proxyPlat) });
                    })];
